package com.havencast.remote.dlna
...
object ContentDirectoryClient {
     ...
     */
    fun browse(service: com.havencast.remote.model.UpnpService, objectId: String = ROOT_OBJECT_ID): BrowseResult {
     ...
     */
    fun search(
        service: com.havencast.remote.model.UpnpService,
        keyword: String,
