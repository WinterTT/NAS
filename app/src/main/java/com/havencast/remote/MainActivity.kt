...
import com.havencast.remote.dlna.MediaKind
import com.havencast.remote.dlna.MediaKinds
import com.havencast.remote.model.MediaContainer
import com.havencast.remote.model.MediaItem
import com.havencast.remote.model.UpnpAction
import com.havencast.remote.model.UpnpDevice
import com.havencast.remote.model.UpnpService
import com.havencast.remote.soap.SoapCaller
...
class MainActivity : AppCompatActivity() {
    ...
    private val libraryServers = ArrayList<Pair<Entry, com.havencast.remote.model.UpnpService>>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm.startPlaybackLoopsOnce() // VM 属性与 UI 状态均已就绪后，再启动常驻播放循环
        ...
        Log.i(TAG, "[UI] HavenCast 启动完成，等待用户操作")
    ...
    companion object {
        ...
        /** logcat 统一 TAG：adb logcat -s HavenCast 过滤 */
