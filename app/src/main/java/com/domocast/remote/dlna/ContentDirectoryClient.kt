package com.domocast.remote.dlna
...
object ContentDirectoryClient {
     ...
     */
    fun browse(service: com.domocast.remote.model.UpnpService, objectId: String = ROOT_OBJECT_ID): BrowseResult {
     ...
     */
    fun search(
        service: com.domocast.remote.model.UpnpService,
        keyword: String,
